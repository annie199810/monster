    ...
    <>
      <div className="competitors">
        <div className="competitors-title">
          <h1>
            Why Choose Sparx IT Solutions for a Hybrid App Development Company?
          </h1>
          <h3>
            Choose Us to get ahead of competitors and get top-rated services We
            know there is fierce competition out there, but here’s why choosing
            us is a beneficial choice
          </h3>
        </div>
