...
import "./walletread.css";
const WalletReadmore = () => {
  const popup = [
    {
      read: "8 mins read",
    ...
    {
      read: "4 mins read",
      name: "Your Ulyimate Guide Crypto Arbitrage Trade Bot:All you..",
      info: "When it comes to trading, it seems that risk is an indispensable part of it. However, arbitrage has been a...",
      link: "read more",
    },
    {
      read: "5 mins read",
      name: "Everything You Nedd to Know About Flash Loans in DeFi",
